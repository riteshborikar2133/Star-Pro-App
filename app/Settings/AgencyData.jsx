...
// Helper to get formatted month list
const getMonthList = () => {
  const now = new Date();
  const months = [];
  ...
  return (
    <View style={{ flex: 1, backgroundColor: theme.background }}>
      ...
      <View style={styles.container}>
        ...
        {/* Table Header */}
        <View
          style={[styles.row, styles.headerRow, { backgroundColor: "#333" }]}
        >
          <Text
            style={[
              styles.cell,
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <View style={[styles.row, { backgroundColor: theme.background }]}>
              ...
              <Text style={[styles.cell, { color: theme.heading }]}>
                {item.tier}
              </Text>
              <View
                style={[
              ...
              >
                ...
                />
                <Text style={[{ color: theme.heading, textAlign: "center" }]}>
                  {item.commission}
                </Text>
              </View>
            </View>
