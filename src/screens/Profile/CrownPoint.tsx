...
const CrownPoint = () => {
  ...
  const levels = Array.from({length: 50}, (_, i) => ({
    ...
    icon: require('../../../assets/Icon/profile/crownicon.png'),
  }));
  return (
    <>
      <OtherHeader title="Crown Point" />
      <View style={[styles.container, {backgroundColor: theme.background}]}>
        <View style={{marginHorizontal: wp(2)}}>
          <ImageBackground
            source={require('../../../assets/Icon/profile/crownpointbg.png')}
          ...
          >
            <View
              ...
              <Image
                source={require('../../../assets/Icon/profile/crownicon.png')}
        ...
        <View
          ...
          <Text
            ...
            Grab Crown Points by receiving gifts to increase crown level.
          </Text>
        </View>
        <View
