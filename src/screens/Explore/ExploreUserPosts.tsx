...
const ExploreUserPosts: React.FC<ExploreUserPosts> = ({
  setPostCount,
  userInfo,
}) => {
      ...
      const getData = async () => {
        ...
        try {
          const res = await axios.get(
            `https://proxstream.online/auth/post/postsbyuser?usercode=${userInfo?.code}`,
            {
              headers: {
...
export default ExploreUserPosts;
